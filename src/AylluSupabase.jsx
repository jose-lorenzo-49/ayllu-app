...
export default function AylluSupabase() {
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Cargando Ayllu UNMSM...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="grid md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
            <div className="text-white space-y-6">
              ...
              <div className="inline-flex items-center gap-2 bg-green-500/20 backdrop-blur-sm border border-green-400/30 rounded-full px-4 py-2">
                ...
                <span className="text-green-100 font-medium">{users.length} estudiantes registrados</span>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-20 pb-8">
          ...
          <div className="flex space-x-3">
            ...
            <div className="flex-1">
              <textarea
                ...
                placeholder="¿Qué quieres compartir con la comunidad sanmarquina?"
        ...
        {allPosts.length === 0 && (
          <div className="bg-gray-900 p-8 rounded-2xl text-center">
            ...
            <h3 className="text-xl font-bold mb-2">¡Bienvenido a Ayllu UNMSM!</h3>
